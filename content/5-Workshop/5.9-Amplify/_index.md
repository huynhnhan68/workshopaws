...
2. Choose **New app** ↁE**Host web app**, connect to the repository containing the Frontend source code (GitHub/GitLab/Bitbucket) and select the correct branch to deploy.
3. Name the app `smartcv-frontend`.

![Initializing the Amplify App name](/images/5-Workshop/5.9-Amplify/5.9.1.png)
**Figure 5.9.1**  EInitializing the Amplify App with the name `smartcv-frontend`.
...
2. Check the deployment status of the selected branch  Eif it shows **Deployed** with a green checkmark, the Frontend has been successfully deployed.

![Checking successful deployment on Amplify](/images/5-Workshop/5.9-Amplify/5.9.2.png)
**Figure 5.9.2**  E"Deployed" status (green checkmark) on the Amplify Console.
